    ...
    <div class="ml-5 mr-5">
      <v-layout row wrap>
        <v-flex xs12 md6 order-md2>
          ...
          <p v-for="text in volunteerData.text" :key="text.id">{{text}}</p>
          <p>
            -VAYA (For more info email us at
            <a href="mailto:volunteer@sdtet.com">volunteer@sdtet.com</a>)
          </p>
        </v-flex>
        <v-flex xs12 md6>
                ...
                >
                  <div class="sdtet-text-align-center">
                    <img
                      ...
                      alt="Consent and Release of Liability Form"
                    />
                    <br />
                    <strong>required:</strong>
                    <br />Consent & Release
                    <br />of Liability Form
                  </div>
                </v-btn>
              </v-flex>
              <v-flex md6>
